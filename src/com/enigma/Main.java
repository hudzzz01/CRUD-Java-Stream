...
public class Main {
    public static void main(String[] args) {
        ...
        service.create(new Nasabah(2,"miya",25,200.01,"baik",5));
        service.create(new Nasabah(3,"balmon",30,500.01,"baik",5));
        service.create(new Nasabah(4,"angela",14,200.01,"baik",5));
        service.create(new Nasabah(5,"hanabi",23,20.01,"buruk",5));
//        service.read();
